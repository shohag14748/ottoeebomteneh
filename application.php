<?php
// if there ia post
if(isset( $_POST['name']) && $_POST['name'] == "" || isset($_POST['email']) && $_POST['email'] == "" || isset($_POST['phone']) && $_POST['phone'] == "" || isset( $_POST['company']) && $_POST['subject'] == "subject") {
...
<!--                    <h1 class="title">Application for Employment</h1>-->
<!--                </div>-->
<!--            </div>-->
<!--        </div>-->
<!--    </section>-->
            ...
            <div class="row">
                <div class="col-md-12 text-left mt-1 row">
                    <div class="text-center">
                        <h2 class="mb-4">Submit your resume</h2>
                    </div>
                    ...
                    <div id="formmessage" style="color: red; margin-bottom: 20px;"><?php
                        ...
                        ?></div>
                    <form id="contactform" class="col-md-8 col-md-offset-2" role="form" method="post" action="" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                               <label for="file">Upload Your Resume*</label>
                                <input type="file" name="attach[]" id="file" style="padding: 7px 20px; border: 2px solid #e6e6e6; width: 100%;" placeholder="Email*">
                            </div>

        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-left mt-1 ">
                   <p>We are dedicated to support the person experiencing exceptional needs and their families through a workforce that displays the highest level of ethics, provides exceptional customer service and honor all commitments.</p>
                </div>
            </div>
        </div>
    </section>
    <section class="inner-intro small-intro theme-bg">
            <div class="container">
               <div class="row intro-title">
                  ...
                  <div class="col-sm-12">
                     <div class="row">
                        <div class="col-sm-12 text-center"><span class="sub-title">We provide you with your staffing needs and connect you to resources to enhance the needs of the people experiencing disability</span></div>
                        <div style="display: flex;justify-content: center; width: 100%;padding-top: 30px;">
                            <a href="request.php" class=" btn btn-default btn-outline animated btn-radius white-border theme-bg white-text fill-white">Request An Employee<i class="fa fa-arrow-right" aria-hidden="true"></i></a>
                        </div>
                     </div>
                  </div>
               </div>

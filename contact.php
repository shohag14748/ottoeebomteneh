               ...
               <div class="row">
                  ...
                  <div class="col-md-4 col-sm-6 mb-4">
                     ...
                     <ul class="icon-list2 lead">
                        <li><span class="lnr lnr-map-marker"></span><span>McCauley Edmonton <br> AB, Canada</span></li>
                        <li><span class="lnr lnr-envelope"></span>theoutcomenetwork@gmail.com</li>
                        <li><span class="lnr lnr-phone-handset"></span>705-881-4614</li>
                     </ul>
                     <div class="mt-2">
